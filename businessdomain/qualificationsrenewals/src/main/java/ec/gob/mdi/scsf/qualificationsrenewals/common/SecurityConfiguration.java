 ...
 */
package ec.gob.mdi.scsf.qualificationsrenewals.common;
...
@Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/v1/qualificationsrenewals/**").permitAll() // Permitir acceso a tus endpoints
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("/h2-console/**"); // Ignorar H2 Console, si es necesario
    }
